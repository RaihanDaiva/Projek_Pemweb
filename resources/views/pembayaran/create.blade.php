    ...
    <!-- Sidebar End -->
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <form action="{{ route('pembayaran.store') }}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" style="box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);
        ...
        <tr>
            ...
            <td>
                <div style="display: flex; gap: 10px;">
                    ...
                    <!-- Input untuk waktu -->
                    <input class="form-control" type="time" id="waktu" name="waktu" step="1" required>
                </div>
            </td>
        </tr>                            
        <tr>
