                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">
                            ...
                            <div class="dropdown-menu show bg-transparent border-0">
                                ...
                                <a href="#" class="dropdown-item active">Pembayaran</a>
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <div class="d-flex justify-content-center mt-5">
                    <form action="{{ route('pembayaran.update', $pembayaran->id_pembayaran)}}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" style="box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                        ...
                        <table>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 10px;">
                                            ...
                                            <input class="form-control" type="date" id="tanggal" name="tanggal" 
                                                value="{{ old('tanggal', $pembayaran->waktu_pembayaran ? \Carbon\Carbon::parse($pembayaran->waktu_pembayaran)->format('Y-m-d') : '') }}" 
                                                readonly>
                                            
                                            <!-- Input untuk waktu -->
                                            <input class="form-control" type="time" id="waktu" name="waktu" step="1" 
                                                value="{{ old('waktu', $pembayaran->waktu_pembayaran ? \Carbon\Carbon::parse($pembayaran->waktu_pembayaran)->format('H:i:s') : '') }}" 
                                                readonly>
                            ...
                            <tr>
                                <td>Jumlah Obat</td>
                                <td>
                                    <input type="number" class="form-control" name="jumlah_obat" value="{{ $pembayaran->jumlah_obat ?? 1 }}" min="1" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
