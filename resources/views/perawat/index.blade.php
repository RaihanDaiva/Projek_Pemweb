...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                                                ...
                                                <table class="table table-striped mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="data">
                                                            ...
                                                            <td class="text-dark">{{ $p->id_perawat }}</td>
                                                            <td class="text-dark">{{ $p->nama_perawat }}</td>
                                                            <td class="text-dark">{{ $p->nomor_lisensi }}</td>
                                                            <td class="text-dark">{{ $p->jadwal_kerja }}</td>
                                                            <td class="text-dark">{{ $p->pengalaman }}</td>
                                                            <td class="text-dark">{{ $p->kontak }}</td>
                                                            <td>
                                                                <!-- Aksi seperti Edit atau Hapus -->
                                                                <a href="{{ route('perawat.edit', $p->id_perawat) }}" style="background-color: #002d72;" class="btn btn-sm"><i class="fa-solid fa-pen-to-square"
                                                                style="color: #ffffff"></i></a>
                                                                <form action="{{ route('perawat.destroy', $p->id_perawat) }}" method="POST" style="display:inline;">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('perawat.create') }}" class="btn btn-lg btn-primary btn-lg-square"
