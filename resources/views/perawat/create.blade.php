    ...
    <!-- Sidebar End -->
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <form action="{{ route('perawat.store') }}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" 
                        ...
                        <table>
                            <tr>
                                <td>Nama</td>
                                <td>
                                    <input type="text" class="form-control" name="nama_perawat" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>No Lisensi</td>
                            ...
                            <tr>
                                <td>Jadwal Kerja</td>
                                <td>
                                    <input type="text" class="form-control" name="jadwal_kerja" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Pengalaman</td>
                                <td>
                                    <input type="text" class="form-control" name="pengalaman" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Kontak</td>
