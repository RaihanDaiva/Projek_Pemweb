                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">
                            ...
                            <div class="dropdown-menu show bg-transparent border-0">
                                ...
                                <a href="#" class="dropdown-item active">Rekam Medis</a>
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <div class="d-flex justify-content-center mt-5">
                    <form action="{{ route('rekam_medis.update', $rekam_medis->id_rekam_medis)}}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" style="box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Diagnosa</td>
                                <td>
                                    <input type="text" class="form-control" name="diagnosa" value="{{ $rekam_medis->diagnosa }}">
                                </td>
                            </tr>
                            <tr>
                                <td>Tgl Kunjungan</td>
                                <td>
                                    <div style="display: flex; gap: 10px;">
                                        <!-- Input untuk tanggal -->
                                        <input class="form-control" type="date" name="tanggal_kunjungan" 
                                            value="{{ old('tanggal', $rekam_medis->tanggal_kunjungan ? \Carbon\Carbon::parse($rekam_medis->tanggal_kunjungan)->format('Y-m-d') : '') }}" 
                                            readonly>                                        
                                    </div>
                                </td>
                            </tr>  
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" name="tindakan_medis" value="{{ $rekam_medis->tindakan_medis }}">
                                </td>
                            </tr>                            
                            <tr>
                                <td>No Obat</td>
