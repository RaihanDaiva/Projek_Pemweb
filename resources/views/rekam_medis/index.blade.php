...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                                                ...
                                                <table class="table table-striped mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="data">
                                                            ...
                                                            <td class="text-dark">{{ $p->id_rekam_medis }}</td>
                                                            <td class="text-dark">
                                                                {{ $p->id_pasien }} - {{ $p->pasien->nama_pasien ?? 'Tidak Ditemukan' }}
                                                            </td>
                                                            <td class="text-dark">
                                                                {{ $p->id_dokter }} - {{ $p->dokter->nama_dokter ?? 'Tidak Ditemukan' }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('rekam_medis.edit', $p->id_rekam_medis) }}" style="background-color: #002d72;" class="btn btn-sm">
                                                                    <i class="fa-solid fa-pen-to-square" style="color: #ffffff"></i>
                                                                </a>
                                                                <form action="{{ route('rekam_medis.destroy', $p->id_rekam_medis) }}" method="POST" style="display:inline;">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('rekam_medis.create') }}" class="btn btn-lg btn-primary btn-lg-square"
