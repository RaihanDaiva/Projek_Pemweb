    ...
    <!-- Sidebar End -->
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <form action="{{ route('obat.store') }}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" 
                        ...
                        <table>
                            <tr>
                                <td>Nama</td>
                                <td>
                                    <input type="text" class="form-control" name="nama_obat" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Harga Obat</td>
                                <td>
                                    <input type="text" class="form-control" name="harga_obat" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="pt-3">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button type="button" style="width: 100px;" 
                                                ...
                                                onclick="window.location.href='{{ route('obat.index') }}';">
                                            BATAL
                                        </button>
                                    </div>
                                </td>
