        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <div class="d-flex justify-content-center mt-5">
                    <form action="{{ route('kasir.update', $kasir->id_kasir)}}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" style="box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Jadwal Kerja</td>
                                <td>
                                    <input type="text" class="form-control" name="jadwal_kerja" value="{{ $kasir->jadwal_kerja }}">
                                </td>
                            </tr>
