                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu show bg-transparent border-0">
                            ...
                            <div class="dropdown-submenu show bg-transparent border-0">
                                ...
                                <a href="#" class="dropdown-item active" style="margin-left:10px ;">Kasir</a>
                        </div>
    ...
    <!-- Sidebar End -->
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <form action="{{ route('kasir.store') }}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" 
                        ...
                        <table>
                            <tr>
                                <td>Nama</td>
                                <td>
                                    <input type="text" class="form-control" name="nama_kasir" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Jadwal Kerja</td>
