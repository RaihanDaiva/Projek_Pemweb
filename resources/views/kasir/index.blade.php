...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="data">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('kasir.edit', $p->id_kasir) }}" style="background-color: #002d72;" class="btn btn-sm"><i class="fa-solid fa-pen-to-square"
                                                                style="color: #ffffff"></i></a>
                                                                <form action="{{ route('kasir.destroy', $p->id_kasir) }}" method="POST" style="display:inline;">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('kasir.create') }}" class="btn btn-lg btn-primary btn-lg-square"
