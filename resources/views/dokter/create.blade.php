    ...
    <!-- Sidebar End -->
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <form action="{{ route('dokter.store') }}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" 
                        style="box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22); 
                        ...
                        <table>
                            <tr>
                                <td>Nama</td>
                                <td>
                                    <input type="text" class="form-control" name="nama_dokter" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>No Lisensi</td>
                                <td>
                                    <input type="text" class="form-control" name="nomor_lisensi" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Spesialisasi</td>
                                <td>
                                    <input type="text" class="form-control" name="spesialisasi" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Jadwal Praktek</td>
                                <td>
                                    <input type="text" class="form-control" name="jadwal_praktek" value="" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Kontak</td>
