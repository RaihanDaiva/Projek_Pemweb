        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <div class="d-flex justify-content-center mt-5">
                    <form action="{{ route('dokter.update', $dokter->id_dokter)}}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" style="box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>No Lisensi</td>
                                <td>
                                    <input type="text" class="form-control" name="nomor_lisensi" value="{{ $dokter->nomor_lisensi }}" readonly>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Spesialisasi</td>
                                <td>
                                    <input type="text" class="form-control" name="spesialisasi" value="{{ $dokter->spesialisasi }}" readonly>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" name="jadwal_praktek" value="{{ $dokter->jadwal_praktek }}">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Kontak</td>
                                <td>
                                    <input type="text" class="form-control" name="kontak" value="{{ $dokter->kontak }}">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="pt-3">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button type="submit" style="width: 100px;" 
                                                ...
                                                onclick="window.location.href='{{ route('dokter.index') }}';">
                                            SIMPAN
                                        </button>
