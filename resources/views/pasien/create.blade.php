                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">
                            ...
                            <div class="dropdown-menu show bg-transparent border-0">
                                ...
                                <a href="#" class="dropdown-item active">Pasien</a>
        ...
        <div class="content" style="height: 120vh   ">
            ...
            <!-- Navbar End -->
                ...
                <div class="d-flex justify-content-center mt-5">
                    <form action="{{ route('pasien.store') }}" method="POST" class="text-dark bg-light bg-gradient p-5 rounded-3" 
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" name="riwayat_penyakit" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>Riwayat Pengobatan</td>
                                <td>
                                    <input type="text" class="form-control" name="riwayat_pengobatan" value="">
                                </td>
                            </tr>
                            <tr>
                                <td>No User</td>
                                ...
                                <td class="pt-3">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button type="button" style="width: 100px;" 
                                                ...
                                                onclick="window.location.href='{{ route('pasien.index') }}';">
                                            BATAL
                                        </button>
                                    </div>
                                </td>
