                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu show bg-transparent border-0">
                            <a href="#" class="dropdown-item active">User</a>
    ...
    <div class="content" style="max-height: 100vh">
        ...
        <nav class="navbar navbar-expand bg-light navbar-light px-4 py-3">
            ...
            <div class="bg-light rounded d-flex align-items-center justify-content-between gap-3 ">
                ...
                <h1 style="margin-bottom: 0px;" class="text-primary ">Tabel User</h1>
            </div>
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                                                ...
                                                <table class="table table-striped mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="data">
                                                            ...
                                                            <td class="text-dark">{{ $p->email }}</td>
                                                            <td class="text-dark">{{ $p->password }}</td>
                                                            <td class="text-dark">{{ $p->role }}</td>
                                                            <td>
                                                                <!-- Aksi seperti Edit atau Hapus -->
                                                                <a href="{{ route('user.edit', $p->id) }}" style="background-color: #002d72;" class="btn btn-sm"><i class="fa-solid fa-pen-to-square"
                                                                style="color: #ffffff"></i></a>
                                                                <form action="{{ route('user.destroy', $p->id) }}" method="POST" style="display:inline;">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('user.create') }}" class="btn btn-lg btn-primary btn-lg-square"
